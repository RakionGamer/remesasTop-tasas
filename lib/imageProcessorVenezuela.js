...
const coordinates = {
  chile: { x: 347, y: 416 },
  peru: { x: 347, y: 703 },
  colombia: { x: 347, y: 558 },
  usa: { x: 857, y: 689 },
  ecuador: { x: 347, y: 829 },
  brasil: { x: 347, y: 959 },
  mexico: { x: 857, y: 519 },
  argentina: { x: 857, y: 848 }
};

const baseImageUrl = 'https://res.cloudinary.com/dvh3nrsun/image/upload/v1775192334/1_cbtcl9.png';
...
export async function createImageWithRatesVenezuela(extractedData, tasasVenezuela) {
  try {
    ...
    // ⚠️ NOTA: Ajusta estas coordenadas si la fecha/hora van en otro lado
